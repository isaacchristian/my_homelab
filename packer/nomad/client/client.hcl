...
data_dir = "/Users/isaac.christian/nomad/data"
...
advertise {
  ...
  http = "127.0.0.1" # must be reachable by Nomad CLI clients
  rpc  = "127.0.0.1" # must be reachable by Nomad client nodes
  serf = "127.0.0.1" # must be reachable by Nomad server nodes
}
...
log_level = "INFO"
log_file  = "/Users/isaac.christian/nomad/isaacchristian.log"
